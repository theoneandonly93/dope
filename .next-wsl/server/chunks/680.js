...
{
    try {
        converter = __webpack_require__(8744)('bigint_buffer');
    }
    catch (e) {
...
var fs = __webpack_require__(7147),
  ...
  fileURLToPath = __webpack_require__(8979),
  join = path.join,
...
var sep = (__webpack_require__(1017).sep) || '/';
...
__webpack_require__.d(__webpack_exports__, {
  Xg: () => (/* reexport */ bool),
  ZL: () => (/* reexport */ publicKey),
  AW: () => (/* reexport */ u64)
});

// UNUSED EXPORTS: WAD, bigInt, bigIntBE, decimal, encodeDecode, u128, u128be, u192, u192be, u256, u256be, u64be

// EXTERNAL MODULE: ./node_modules/@solana/buffer-layout/lib/Layout.js
var Layout = __webpack_require__(1895);
// EXTERNAL MODULE: ./node_modules/bigint-buffer/dist/node.js
var node = __webpack_require__(5211);
...
const bigInt = (length) => (property) => {
    ...
    bigIntLayout.decode = (buffer, offset) => {
        ...
        return (0,node/* toBigIntLE */.oU)(Buffer.from(src));
    };
    bigIntLayout.encode = (bigInt, buffer, offset) => {
        const src = (0,node/* toBufferLE */.k$)(bigInt, length);
...
const bigIntBE = (length) => (property) => {
    ...
    bigIntLayout.decode = (buffer, offset) => {
        const src = decode(buffer, offset);
        return (0,node/* toBigIntBE */.Q5)(Buffer.from(src));
    };
    bigIntLayout.encode = (bigInt, buffer, offset) => {
        const src = (0,node/* toBufferBE */.zP)(bigInt, length);
        return encode(src, buffer, offset);
    };
    return bigIntLayout;
};
...
var index_cjs = __webpack_require__(5766);
;// CONCATENATED MODULE: ./node_modules/@solana/buffer-layout-utils/lib/esm/web3.mjs



const publicKey = (property) => {
    const layout = (0,Layout.blob)(32, property);
    const { encode, decode } = base_encodeDecode(layout);
    const publicKeyLayout = layout;
    publicKeyLayout.decode = (buffer, offset) => {
        const src = decode(buffer, offset);
        return new index_cjs/* PublicKey */.nh(src);
    };
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  _: () => (/* binding */ getOrCreateAssociatedTokenAccount)
});

// EXTERNAL MODULE: ./node_modules/@solana/web3.js/lib/index.cjs.js
var index_cjs = __webpack_require__(5766);
// EXTERNAL MODULE: ./node_modules/@solana/spl-token/lib/esm/constants.js
var constants = __webpack_require__(3969);
...
class errors_TokenAccountNotFoundError extends TokenError {
    constructor() {
        super(...arguments);
...
class TokenInvalidAccountDataError extends (/* unused pure expression or super */ null && (TokenError)) {
    constructor() {
        super(...arguments);
...
class errors_TokenInvalidAccountOwnerError extends TokenError {
    constructor() {
        super(...arguments);
...
class errors_TokenInvalidAccountSizeError extends TokenError {
    constructor() {
        super(...arguments);
...
class errors_TokenInvalidMintError extends TokenError {
    constructor() {
        super(...arguments);
...
class TokenTransferHookAccountNotFound extends (/* unused pure expression or super */ null && (TokenError)) {
    constructor() {
        super(...arguments);
...
class TokenTransferHookInvalidSeed extends (/* unused pure expression or super */ null && (TokenError)) {
    constructor() {
        super(...arguments);
...
class TokenTransferHookAccountDataNotFound extends (/* unused pure expression or super */ null && (TokenError)) {
    constructor() {
        super(...arguments);
...
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/instructions/associatedTokenAccount.js
 ...
 */
function createAssociatedTokenAccountInstruction(payer, associatedToken, owner, mint, programId = constants/* TOKEN_PROGRAM_ID */.H_, associatedTokenProgramId = constants/* ASSOCIATED_TOKEN_PROGRAM_ID */._u) {
...
function buildAssociatedTokenAccountInstruction(payer, associatedToken, owner, mint, instructionData, programId = constants/* TOKEN_PROGRAM_ID */.H_, associatedTokenProgramId = constants/* ASSOCIATED_TOKEN_PROGRAM_ID */._u) {
    const keys = [
        { pubkey: payer, isSigner: true, isWritable: true },
        { pubkey: associatedToken, isSigner: false, isWritable: true },
        { pubkey: owner, isSigner: false, isWritable: false },
        { pubkey: mint, isSigner: false, isWritable: false },
        { pubkey: index_cjs/* SystemProgram */.yc.programId, isSigner: false, isWritable: false },
        { pubkey: programId, isSigner: false, isWritable: false },
    ];
    return new index_cjs/* TransactionInstruction */.Sl({
        keys,
...
// EXTERNAL MODULE: ./node_modules/@solana/buffer-layout/lib/Layout.js
var Layout = __webpack_require__(1895);
// EXTERNAL MODULE: ./node_modules/@solana/buffer-layout-utils/lib/esm/index.mjs + 6 modules
var esm = __webpack_require__(9684);
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/extensions/accountType.js
var accountType_AccountType;
(function (AccountType) {
    AccountType[AccountType["Uninitialized"] = 0] = "Uninitialized";
    AccountType[AccountType["Mint"] = 1] = "Mint";
    AccountType[AccountType["Account"] = 2] = "Account";
})(accountType_AccountType || (accountType_AccountType = {}));
const accountType_ACCOUNT_TYPE_SIZE = 1;
//# sourceMappingURL=accountType.js.map
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/state/multisig.js




/** Buffer layout for de/serializing a multisig */
const MultisigLayout = (0,Layout.struct)([
    (0,Layout.u8)('m'),
    (0,Layout.u8)('n'),
    (0,esm/* bool */.Xg)('isInitialized'),
    (0,esm/* publicKey */.ZL)('signer1'),
    (0,esm/* publicKey */.ZL)('signer2'),
    (0,esm/* publicKey */.ZL)('signer3'),
    (0,esm/* publicKey */.ZL)('signer4'),
    (0,esm/* publicKey */.ZL)('signer5'),
    (0,esm/* publicKey */.ZL)('signer6'),
    (0,esm/* publicKey */.ZL)('signer7'),
    (0,esm/* publicKey */.ZL)('signer8'),
    (0,esm/* publicKey */.ZL)('signer9'),
    (0,esm/* publicKey */.ZL)('signer10'),
    (0,esm/* publicKey */.ZL)('signer11'),
]);
/** Byte length of a multisig */
const multisig_MULTISIG_SIZE = MultisigLayout.span;
/**
...
function unpackMultisig(address, info, programId = TOKEN_PROGRAM_ID) {
    ...
    if (info.data.length != multisig_MULTISIG_SIZE)
...
async function getMinimumBalanceForRentExemptMultisig(connection, commitment) {
    return await connection.getMinimumBalanceForRentExemption(multisig_MULTISIG_SIZE, commitment);
}
//# sourceMappingURL=multisig.js.map
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/state/account.js
...
const AccountLayout = (0,Layout.struct)([
    (0,esm/* publicKey */.ZL)('mint'),
    (0,esm/* publicKey */.ZL)('owner'),
    (0,esm/* u64 */.AW)('amount'),
    (0,Layout.u32)('delegateOption'),
    (0,esm/* publicKey */.ZL)('delegate'),
    (0,Layout.u8)('state'),
    (0,Layout.u32)('isNativeOption'),
    (0,esm/* u64 */.AW)('isNative'),
    (0,esm/* u64 */.AW)('delegatedAmount'),
    (0,Layout.u32)('closeAuthorityOption'),
    (0,esm/* publicKey */.ZL)('closeAuthority'),
]);
/** Byte length of a token account */
const account_ACCOUNT_SIZE = AccountLayout.span;
/**
 ...
 */
async function getAccount(connection, address, commitment, programId = constants/* TOKEN_PROGRAM_ID */.H_) {
    const info = await connection.getAccountInfo(address, commitment);
 ...
 */
function unpackAccount(address, info, programId = constants/* TOKEN_PROGRAM_ID */.H_) {
    if (!info)
        throw new errors_TokenAccountNotFoundError();
    if (!info.owner.equals(programId))
        throw new errors_TokenInvalidAccountOwnerError();
    if (info.data.length < account_ACCOUNT_SIZE)
        throw new errors_TokenInvalidAccountSizeError();
    const rawAccount = AccountLayout.decode(info.data.slice(0, account_ACCOUNT_SIZE));
    let tlvData = Buffer.alloc(0);
    if (info.data.length > account_ACCOUNT_SIZE) {
        if (info.data.length === multisig_MULTISIG_SIZE)
            throw new errors_TokenInvalidAccountSizeError();
        if (info.data[account_ACCOUNT_SIZE] != accountType_AccountType.Account)
            throw new TokenInvalidAccountError();
        tlvData = info.data.slice(account_ACCOUNT_SIZE + accountType_ACCOUNT_TYPE_SIZE);
    }
    return {
        address,
...
const MintLayout = (0,Layout.struct)([
    (0,Layout.u32)('mintAuthorityOption'),
    (0,esm/* publicKey */.ZL)('mintAuthority'),
    (0,esm/* u64 */.AW)('supply'),
    (0,Layout.u8)('decimals'),
    (0,esm/* bool */.Xg)('isInitialized'),
    (0,Layout.u32)('freezeAuthorityOption'),
    (0,esm/* publicKey */.ZL)('freezeAuthority'),
]);
 ...
 */
function getAssociatedTokenAddressSync(mint, owner, allowOwnerOffCurve = false, programId = constants/* TOKEN_PROGRAM_ID */.H_, associatedTokenProgramId = constants/* ASSOCIATED_TOKEN_PROGRAM_ID */._u) {
    if (!allowOwnerOffCurve && !index_cjs/* PublicKey */.nh.isOnCurve(owner.toBuffer()))
        throw new errors_TokenOwnerOffCurveError();
    const [address] = index_cjs/* PublicKey */.nh.findProgramAddressSync([owner.toBuffer(), programId.toBuffer(), mint.toBuffer()], associatedTokenProgramId);
    return address;
}
//# sourceMappingURL=mint.js.map
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/actions/getOrCreateAssociatedTokenAccount.js
 ...
 */
async function getOrCreateAssociatedTokenAccount(connection, payer, mint, owner, allowOwnerOffCurve = false, commitment, confirmOptions, programId = constants/* TOKEN_PROGRAM_ID */.H_, associatedTokenProgramId = constants/* ASSOCIATED_TOKEN_PROGRAM_ID */._u) {
    ...
    try {
        ...
        if (error instanceof errors_TokenAccountNotFoundError || error instanceof errors_TokenInvalidAccountOwnerError) {
            // As this isn't atomic, it's possible others can create associated accounts meanwhile.
            try {
                const transaction = new index_cjs/* Transaction */.YW().add(createAssociatedTokenAccountInstruction(payer.publicKey, associatedToken, owner, mint, programId, associatedTokenProgramId));
                await (0,index_cjs/* sendAndConfirmTransaction */.BV)(connection, transaction, [payer], confirmOptions);
            }
            catch (error) {
    ...
    if (!account.mint.equals(mint))
        throw new errors_TokenInvalidMintError();
...
// EXTERNAL MODULE: ./node_modules/@solana/buffer-layout-utils/lib/esm/index.mjs + 6 modules
var esm = __webpack_require__(9684);
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/instructions/internal.js
...
function addSigners(keys, ownerOrAuthority, multiSigners) {
    if (multiSigners.length) {
        ...
        for (const signer of multiSigners) {
            keys.push({
                pubkey: signer instanceof index_cjs/* PublicKey */.nh ? signer : signer.publicKey,
                isSigner: true,
                isWritable: false,
            });
        }
...
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/instructions/types.js
/** Instructions defined by the program */
var types_TokenInstruction;
...
})(types_TokenInstruction || (types_TokenInstruction = {}));
//# sourceMappingURL=types.js.map
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/instructions/transferChecked.js
...
/** TODO: docs */
const transferCheckedInstructionData = (0,Layout.struct)([
    (0,Layout.u8)('instruction'),
    (0,esm/* u64 */.AW)('amount'),
    (0,Layout.u8)('decimals'),
]);
/**
 ...
 * @return Instruction to add to a transaction
 */
function createTransferCheckedInstruction(source, mint, destination, owner, amount, decimals, multiSigners = [], programId = constants/* TOKEN_PROGRAM_ID */.H_) {
    ...
    transferCheckedInstructionData.encode({
        instruction: types_TokenInstruction.TransferChecked,
        amount: BigInt(amount),
        decimals,
    }, data);
    return new index_cjs/* TransactionInstruction */.Sl({ keys, programId, data });
}
/**
...
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/actions/internal.js

/** @internal */
function getSigners(signerOrMultisig, multiSigners) {
    return signerOrMultisig instanceof index_cjs/* PublicKey */.nh
        ? [signerOrMultisig, multiSigners]
        : [signerOrMultisig.publicKey, [signerOrMultisig]];
}
//# sourceMappingURL=internal.js.map
;// CONCATENATED MODULE: ./node_modules/@solana/spl-token/lib/esm/actions/transferChecked.js
 ...
 */
async function transferChecked(connection, payer, source, mint, destination, owner, amount, decimals, multiSigners = [], confirmOptions, programId = constants/* TOKEN_PROGRAM_ID */.H_) {
    const [ownerPublicKey, signers] = getSigners(owner, multiSigners);
    const transaction = new index_cjs/* Transaction */.YW().add(createTransferCheckedInstruction(source, mint, destination, ownerPublicKey, amount, decimals, multiSigners, programId));
    return await (0,index_cjs/* sendAndConfirmTransaction */.BV)(connection, transaction, [payer, ...signers], confirmOptions);
}
//# sourceMappingURL=transferChecked.js.map
...
/* harmony export */   H_: () => (/* binding */ TOKEN_PROGRAM_ID),
/* harmony export */   _u: () => (/* binding */ ASSOCIATED_TOKEN_PROGRAM_ID)
/* harmony export */ });
/* unused harmony exports TOKEN_2022_PROGRAM_ID, NATIVE_MINT, NATIVE_MINT_2022, programSupportsExtensions */
/* harmony import */ var _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5766);

/** Address of the SPL Token program */
const TOKEN_PROGRAM_ID = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh('TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA');
/** Address of the SPL Token 2022 program */
const TOKEN_2022_PROGRAM_ID = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh('TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb');
/** Address of the SPL Associated Token Account program */
const ASSOCIATED_TOKEN_PROGRAM_ID = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh('ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL');
/** Address of the special mint for wrapped native SOL in spl-token */
const NATIVE_MINT = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh('So11111111111111111111111111111111111111112');
/** Address of the special mint for wrapped native SOL in spl-token-2022 */
const NATIVE_MINT_2022 = new _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__/* .PublicKey */ .nh('9pan9bMn5HatX4EJdBwg9VgCa7Uz5HL8N1m5D3NdXejP');
